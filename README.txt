Video link: https://youtu.be/yXBVCzF2w3Y
...
The TurtleDel system is built on **ROS 2** and runs on a **TurtleBot 4 Lite** mobile robot platform. The architecture is modular, with specialized packages handling different aspects of the delivery system.

### Hardware Platform

- **Robot Base**: TurtleBot 4 Lite with Create 3 differential drive platform
- **Primary Sensor**: 2D LIDAR for mapping, localization, and obstacle detection is a RPLIDAR A1M8 360-degree 2D LiDAR sensor with a range of 12 meters.
- **Secondary Sensor**: Fonkan 860-960Mhz UHF RFID Module Long Range Reader with range from 0.5-1 m. https://www.aliexpress.us/item/3256803639172556.html?spm=a2g0o.order_list.order_list_main.5.4bb01802JNhx22&gatewayAdapt=glo2usa.
- **RFID Targets**: ABS UHF RFID Anti-Metal Tag Strip – 860~960MHZ EPC. https://www.amazon.com/dp/B08RMP4Z77.
